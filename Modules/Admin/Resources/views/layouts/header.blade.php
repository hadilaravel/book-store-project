...
{{--                                        <h5 class="notification-user">{{ $notification->data['title'] }}</h5>--}}
{{--                                        <p class="notification-text">{{ \Illuminate\Support\Str::limit($notification->data['description'] , 60) }}</p>--}}
